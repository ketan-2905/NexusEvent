...
const SignupPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // remove confirmPassword before backend call
  ...
  return (
   <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[50%] h-[50%] bg-purple-600/20 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={clsx(
                  "w-full bg-slate-800/50 border border-slate-700 rounded-xl py-3 pl-10 pr-12 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all placeholder:text-slate-600",
                  errors.password && "border-red-500 focus:ring-red-500"
                )}
                placeholder="••••••••"
              />
